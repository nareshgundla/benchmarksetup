...
--100TB
set hive.exec.reducers.bytes.per.reducer=1342177280;
set hive.exec.reducers.bytes.per.reducer=268435436;
set hive.exec.reducers.bytes.per.reducer=536870872;
